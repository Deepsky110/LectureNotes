...
public class MyServlet2 extends GenericServlet {
	...
	protected void doHead(HttpServletRequest req, HttpServletResponse res) throws IOException{ // protected 상속 접근 가능
		res.sendError(res.SC_METHOD_NOT_ALLOWED); // sendError 에러로 처리
	}
